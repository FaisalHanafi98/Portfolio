...
echo "  3. Copy deploy/nginx-portfolio-bootstrap.conf to /etc/nginx/conf.d/portfolio.conf"
...
echo "  9. Replace /etc/nginx/conf.d/portfolio.conf with deploy/nginx-portfolio.conf once the cert exists"
echo " 10. Set GitHub secrets: LIGHTSAIL_SSH_KEY and LIGHTSAIL_IP"
echo ""
